...
const Index = () => {
  ...
  return <div className={`min-h-screen transition-colors ${isDark ? 'dark bg-gray-900' : 'bg-white'}`}>
      {/* Header */}
        ...
        <div className="container mx-auto px-4">
          ...
          <nav className="py-3">
            <div className="flex space-x-6 overflow-x-auto">
              {categories.map(category => <Button key={category} variant="ghost" className="text-white hover:bg-red-700 whitespace-nowrap">
                  {category}
                </Button>)}
            </div>
          </nav>
          ...
          <div className="lg:col-span-3">
            ...
            <div className="mb-8">
              <div className="relative rounded-lg overflow-hidden shadow-lg">
                <img src={featuredNews[0].image} alt={featuredNews[0].title} className="w-full h-64 object-cover" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              {featuredNews.slice(1).map(news => <div key={news.id} className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[1, 2, 3].map(i => <div key={i} className="relative bg-gray-200 dark:bg-gray-700 rounded-lg overflow-hidden">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg mb-6">
              ...
              <div className="space-y-2">
                {states.map(state => <Button key={state} variant="ghost" className="w-full justify-start text-gray-700 dark:text-gray-300 hover:bg-red-50 dark:hover:bg-red-900/20">
                    {state}
                  </Button>)}
              </div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
              ...
              <div className="space-y-3">
                {['Market hits all-time high', 'New policy announcement', 'Celebrity wedding news'].map((trend, i) => <div key={i} className="text-sm text-gray-700 dark:text-gray-300 hover:text-red-600 cursor-pointer">
                    {trend}
                  </div>)}
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div>
              ...
              <div className="space-y-1">
                {categories.slice(0, 4).map(cat => <div key={cat} className="text-gray-400 hover:text-white cursor-pointer">
                    {cat}
                  </div>)}
              </div>
            </div>
